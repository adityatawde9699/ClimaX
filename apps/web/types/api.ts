...
export type Incident = { id: string; title: string; status: string; severity: string; category: string; location: Coordinates; organization_id: string; assigned_officer_id?: string | null; risk_score?: number | null; created_at: string; updated_at: string; resolved_at?: string | null };
